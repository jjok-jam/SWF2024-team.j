...
<p align="center">
  <img width="1006" alt="image" src="https://github.com/user-attachments/assets/a84eb319-1436-4903-a858-bae60c2b48c9">
<p>
...
제노블럭에서 개인 유전체 데이터의 분석 서비스 요청, 접근 권한 설정, 및 분석 결과 공유 과정에서 발생하는 모든 상태 정보는 하이퍼렛저(Hyper-ledger) 블록체인 네트워크에 기록됩니다. 공공기관, 연구소, 유전체 관련 회사 등 데이터와 관련된 모든 기관은 이 블록체인 네트워크에 연결되어 있으며, 각 단계에서의 정보와 상태는 블록체인에 투명하게 저장됩니다. 이를 통해 개인 유전체 데이터의 활용과 관리 과정이 사용자에게 안전하고 신뢰성 있게 공유됩니다.

<p align="center">
  <img width="1622" alt="image" src="https://github.com/user-attachments/assets/3d93bf76-3801-43ea-a57a-b4f8a260feff">
<p>
  
제노블럭의 기대효과는 블록체인 기술을 통한 데이터 관리의 투명성 향상, 개인 맞춤형 의료 서비스 강화, 사용자 데이터 주권 확보, 그리고 유전체 데이터 기반 연구 및 산업 발전 촉진에 있습니다. 이를 통해 사용자 신뢰가 증대되고, 맞춤형 질병 관리가 가능할 것으로 기대됩니다.
