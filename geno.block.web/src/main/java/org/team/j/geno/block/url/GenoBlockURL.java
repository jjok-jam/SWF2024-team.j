...
//	public static final String BASE_URL = "http://127.0.0.1:1818/geno/api/v1/fabric";
	...
	public static final String UPDATE_REPORT_URL = String.join("/", BASE_URL, "update_gene");
	public static final String SELECT_GENE_NO = String.join("/", BASE_URL, "select_user_no");
}
